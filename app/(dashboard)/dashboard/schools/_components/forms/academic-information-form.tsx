    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">Define your school's academic calendar structure</p>
        </div>
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  />
                   {errors[`academicYears[${yearIndex}].yearName`] && <p className="mt-1 text-xs text-red-600">{errors[`academicYears[${yearIndex}].yearName`]}</p>}
                </div>
                <div>
                  ...
                  />
                  {errors[`academicYears[${yearIndex}].startDate`] && <p className="mt-1 text-xs text-red-600">{errors[`academicYears[${yearIndex}].startDate`]}</p>}
                </div>
                <div>
                  ...
                  />
                  {errors[`academicYears[${yearIndex}].endDate`] && <p className="mt-1 text-xs text-red-600">{errors[`academicYears[${yearIndex}].endDate`]}</p>}
                </div>
                ...
                <div className="border-t mt-4 pt-4">
                  ...
                  {year.terms.length === 0 ? (
                    <>
                      ...
                      {errors[`academicYears[${yearIndex}].terms`] && <p className="mt-1 text-xs text-red-600 text-center">{errors[`academicYears[${yearIndex}].terms`]}</p>}
                    </>
                  ) : (
                        ...
                        <div key={term.id} className="bg-gray-50 p-3 rounded border">
                          <div className="grid grid-cols-1 md:grid-cols-5 gap-3 items-end">
                            <div>
                              ...
                              />
                              {errors[`academicYears[${yearIndex}].terms[${termIndex}].termName`] && <p className="mt-1 text-xs text-red-600">{errors[`academicYears[${yearIndex}].terms[${termIndex}].termName`]}</p>}
                            </div>
                            <div>
                              ...
                              />
                              {errors[`academicYears[${yearIndex}].terms[${termIndex}].startDate`] && <p className="mt-1 text-xs text-red-600">{errors[`academicYears[${yearIndex}].terms[${termIndex}].startDate`]}</p>}
                            </div>
                            <div>
                              ...
                              />
                              {errors[`academicYears[${yearIndex}].terms[${termIndex}].endDate`] && <p className="mt-1 text-xs text-red-600">{errors[`academicYears[${yearIndex}].terms[${termIndex}].endDate`]}</p>}
                            </div>
                            <div className="flex items-center space-x-2">
                              <Switch
